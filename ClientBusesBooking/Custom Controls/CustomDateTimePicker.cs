...
namespace AdminBusesBooking.Custom_Controls
{
    public partial class CustomDateTimePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = ClientBusesBooking.Properties.Resources.calendarDark;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = ClientBusesBooking.Properties.Resources.calendarWhite;
                else calendarIcon = ClientBusesBooking.Properties.Resources.calendarDark;
                this.Invalidate();
            }
        }
        [Category("RJ Code Advance")]
